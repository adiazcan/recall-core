...
- [ ] T001 Create infra directory structure with modules folders in infra/
- [ ] T002 [P] Create parameter files structure in infra/parameters/dev.bicepparam and infra/parameters/prod.bicepparam
- [ ] T003 [P] Create helper scripts directory structure in infra/scripts/
...
- [ ] T004 Implement resource-group module in infra/modules/core/resource-group.bicep
- [ ] T005 [P] Implement log-analytics module in infra/modules/core/log-analytics.bicep
- [ ] T006 [P] Implement key-vault module in infra/modules/core/key-vault.bicep
- [ ] T007 [P] Implement app-configuration module in infra/modules/core/app-configuration.bicep
- [ ] T008 [P] Implement container-registry module in infra/modules/container/container-registry.bicep
- [ ] T009 Implement app-insights module in infra/modules/core/app-insights.bicep (depends on T005)
...
- [ ] T010 [P] [US1] Implement storage-account module in infra/modules/storage/storage-account.bicep
- [ ] T011 [P] [US1] Implement storage-roles module in infra/modules/storage/storage-roles.bicep
- [ ] T012 [P] [US1] Implement documentdb module in infra/modules/database/documentdb.bicep
- [ ] T013 [P] [US1] Implement container-apps-env module in infra/modules/container/container-apps-env.bicep
- [ ] T014 [P] [US1] Implement static-web-app module in infra/modules/web/static-web-app.bicep
- [ ] T015 [US1] Implement container-app-api module in infra/modules/container/container-app-api.bicep
- [ ] T016 [US1] Implement container-app-job module in infra/modules/container/container-app-job.bicep
- [ ] T017 [US1] Create main.bicep entry point that orchestrates all modules in infra/main.bicep
- [ ] T018 [US1] Create dev parameter file with environment-specific values in infra/parameters/dev.bicepparam
- [ ] T019 [US1] Create prod parameter file with environment-specific values in infra/parameters/prod.bicepparam
- [ ] T020 [P] [US1] Create deploy.sh helper script in infra/scripts/deploy.sh
- [ ] T021 [P] [US1] Create what-if.sh preview script in infra/scripts/what-if.sh
...
- [ ] T023 [US2] Create Dockerfile for API if not exists in src/Recall.Core.Api/Dockerfile
- [ ] T024 [US2] Configure API Container App health probes in infra/modules/container/container-app-api.bicep
- [ ] T025 [US2] Add Key Vault secret reference for DocumentDB connection in API module
- [ ] T026 [US2] Add App Configuration integration for API module
- [ ] T027 [US2] Add managed identity configuration and RBAC role assignments for API
...
- [ ] T029 [US3] Configure SWA linked backend for API routing in infra/modules/web/static-web-app.bicep
- [ ] T030 [US3] Create staticwebapp.config.json for route configuration in src/web/staticwebapp.config.json
- [ ] T031 [US3] Document CORS fallback for dev environment (Free SKU) in docs/infra/swa-cors-fallback.md
...
- [ ] T033 [US4] Configure DocumentDB firewall rules for Azure services in infra/modules/database/documentdb.bicep
- [ ] T034 [US4] Store DocumentDB connection string in Key Vault via Bicep
- [ ] T035 [US4] Configure API to retrieve connection string from Key Vault via managed identity
...
- [ ] T037 [US5] Configure Storage Queue in storage-account module
- [ ] T038 [US5] Configure ACA Job with Storage Queue trigger in container-app-job module
- [ ] T039 [US5] Create Dockerfile for enrichment job in src/Recall.Core.Enrichment/Dockerfile
- [ ] T040 [US5] Add managed identity and RBAC role assignments for enrichment job
- [ ] T041 [US5] Configure job scaling rules (0-5 executions, polling interval)
...
- [ ] T043 [US6] Configure thumbnails blob container in storage-account module
- [ ] T044 [US6] Add Blob Data Contributor role to API managed identity
- [ ] T045 [US6] Add Blob Data Contributor role to enrichment job managed identity
...
- [ ] T047 [US7] Configure Application Insights connection string in API container app
- [ ] T048 [US7] Configure Application Insights connection string in enrichment job
- [ ] T049 [US7] Add Azure.Monitor.OpenTelemetry.AspNetCore package to API project (if not present)
- [ ] T050 [US7] Implement alerts module for prod environment in infra/modules/core/alerts.bicep
...
- [ ] T053 [P] [US8] Create API deployment workflow in .github/workflows/api-deploy.yml
- [ ] T054 [P] [US8] Create enrichment deployment workflow in .github/workflows/enrichment-deploy.yml
- [ ] T055 [P] [US8] Create web deployment workflow in .github/workflows/web-deploy.yml
- [ ] T056 [US8] Create reusable Azure login workflow in .github/workflows/reusable-azure-login.yml
- [ ] T057 [US8] Create reusable Docker build workflow in .github/workflows/reusable-docker-build.yml
- [ ] T058 [US8] Document GitHub OIDC setup and environment configuration in docs/infra/github-oidc-setup.md
...
- [ ] T060 [P] Create infrastructure overview documentation in docs/infra/overview.md
- [ ] T061 [P] Create operational runbook in docs/infra/runbook.md
- [ ] T062 [P] Create cost documentation in docs/infra/cost.md
- [ ] T063 Run quickstart.md validation for full deployment
- [ ] T064 Update repository README with infrastructure deployment instructions
