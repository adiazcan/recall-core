...
- 003-web-app-integration: Added TypeScript 5.7+ / React 19 / Vite 6 + React Router 7.1, Zustand 5, shadcn/ui (Radix), Tailwind CSS 4, lucide-react, motion

- 002-items-tags-collections-api: Added C# / .NET 10 (net10.0) + ASP.NET Core minimal API, MongoDB.Driver 3.x, Aspire.Hosting.MongoDB (13.1.0)
