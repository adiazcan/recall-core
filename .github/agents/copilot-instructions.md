...
- C# / .NET 10, TypeScript / ES2022 + Aspire 13.1.0, MongoDB.Driver.v2, Microsoft.Playwright, Azure.Storage.Queues, Azure.Storage.Blobs (005-bookmark-enrichment)
- MongoDB (items, enrichment status), Azure Blob Storage (thumbnails), Azure Storage Queue (jobs) (005-bookmark-enrichment)
...
- 005-bookmark-enrichment: Added C# / .NET 10, TypeScript / ES2022 + Aspire 13.1.0, MongoDB.Driver.v2, Microsoft.Playwright, Azure.Storage.Queues, Azure.Storage.Blobs
